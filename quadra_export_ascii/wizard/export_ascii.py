...
QUADRA_ASCII_FORMAT = {  # Quadra name: [Position, Length, required, lambda expr to get value from move lines]
    ...
    "Date échéance": [64, 6, False, lambda l: min(l.mapped('date_maturity')) and min(l.mapped('date_maturity')).strftime("%d%m%y")],
